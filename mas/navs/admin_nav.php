...
<nav id="nav" class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav mr-auto">
      <a class="nav-item nav-link active" href="../admin/home_admin.php">Home<span class="sr-only">(current)</span></a>
      <a class="nav-item nav-link" href="../admin/manage_user.php">Benutzer</a>
      <a class="nav-item nav-link" href="../teacher/manage_teacher.php">Lehrer</a>
      <a class="nav-item nav-link" href="../admin/manage_material.php">Material</a>
      <a class="nav-item nav-link" href="../categorie/manage_categorie.php">Kategorien</a>
