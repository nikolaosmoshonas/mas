...
$total_pages_sql = "SELECT COUNT(*) FROM benutzer";
$result = mysqli_query($conn,$total_pages_sql);
$total_rows = mysqli_fetch_array($result)[0];
$total_pages = ceil($total_rows / $no_of_records_per_page);

$sql = "SELECT * FROM benutzer LIMIT $offset, $no_of_records_per_page";
...
<div class="container">
      ...
      <br>
      <br>
      <a href="add_new_user.php"><button type="button" name="addUser" class="btn btn-success">Benutzer hinzufügen</button></a>
      <br>
      <br>
        ...
        while ($row = mysqli_fetch_assoc($res_data)) {
          ...
          <tbody>
            <tr>
              ...
              <td>
                <a href="update_user.php?edit=<?php echo $row['benutzer_id']; ?>" class="edit_btn warning"><button class="btn btn-warning">Bearbeiten</button></a>
              </td>
              <td>
                <form action="delete_user.php" method="post">
                  <input type="hidden" value="<?php echo $row['benutzer_id']; ?>" name="btn_delete">
